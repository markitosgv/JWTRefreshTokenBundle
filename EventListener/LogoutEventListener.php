...
class LogoutEventListener
{
    ...
    public function __construct(
        ...
        if (null !== $logoutFirewallContext) {
            trigger_deprecation('gesdinet/jwt-refresh-token-bundle', '1.4', 'Passing the logout firewall context to "%s" is deprecated and will not be supported in 2.0.', self::class);
        }
    }
